...
${OBJECTDIR}/FSMbaby.o: FSMbaby.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FSMbaby.o FSMbaby.cpp

${OBJECTDIR}/baby.o: baby.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/baby.o baby.cpp

${OBJECTDIR}/gtest/src/gtest-all.o: gtest/src/gtest-all.cc
	${MKDIR} -p ${OBJECTDIR}/gtest/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gtest/src/gtest-all.o gtest/src/gtest-all.cc
...
${TESTDIR}/_ext/30177beb/gtest-all.o: ../../../../../../../../googletest-master/googletest/src/gtest-all.cc 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/30177beb/gtest-all.o ../../../../../../../../googletest-master/googletest/src/gtest-all.cc


${TESTDIR}/_ext/30177beb/gtest_main.o: ../../../../../../../../googletest-master/googletest/src/gtest_main.cc 
	${MKDIR} -p ${TESTDIR}/_ext/30177beb
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/30177beb/gtest_main.o ../../../../../../../../googletest-master/googletest/src/gtest_main.cc
...
${OBJECTDIR}/FSMbaby_nomain.o: ${OBJECTDIR}/FSMbaby.o FSMbaby.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FSMbaby_nomain.o FSMbaby.cpp;\
	else  \
...
${OBJECTDIR}/baby_nomain.o: ${OBJECTDIR}/baby.o baby.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/baby_nomain.o baby.cpp;\
	else  \
...
${OBJECTDIR}/gtest/src/gtest-all_nomain.o: ${OBJECTDIR}/gtest/src/gtest-all.o gtest/src/gtest-all.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gtest/src/gtest-all_nomain.o gtest/src/gtest-all.cc;\
	else  \
