...
${OBJECTDIR}/_ext/8e9bab0b/gtest-all.o: ../../googletest-master/googletest/src/gtest-all.cc
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8e9bab0b/gtest-all.o ../../googletest-master/googletest/src/gtest-all.cc

${OBJECTDIR}/_ext/8e9bab0b/gtest_main.o: ../../googletest-master/googletest/src/gtest_main.cc
	${MKDIR} -p ${OBJECTDIR}/_ext/8e9bab0b
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8e9bab0b/gtest_main.o ../../googletest-master/googletest/src/gtest_main.cc
