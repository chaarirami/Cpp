...
${OBJECTDIR}/_ext/96e23cfa/gtest-all.o: ../../../../Downloads/googletest-master/googletest-master/googletest/src/gtest-all.cc
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/96e23cfa/gtest-all.o ../../../../Downloads/googletest-master/googletest-master/googletest/src/gtest-all.cc

${OBJECTDIR}/AreaMonitor.o: AreaMonitor.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AreaMonitor.o AreaMonitor.cpp

${OBJECTDIR}/CO2FSM.o: CO2FSM.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CO2FSM.o CO2FSM.cpp
...
${OBJECTDIR}/HumidFSM.o: HumidFSM.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HumidFSM.o HumidFSM.cpp

${OBJECTDIR}/Humidifier.o: Humidifier.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Humidifier.o Humidifier.cpp
...
${TESTDIR}/testi.o: testi.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/testi.o testi.cpp
...
${OBJECTDIR}/_ext/96e23cfa/gtest-all_nomain.o: ${OBJECTDIR}/_ext/96e23cfa/gtest-all.o ../../../../Downloads/googletest-master/googletest-master/googletest/src/gtest-all.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/96e23cfa/gtest-all_nomain.o ../../../../Downloads/googletest-master/googletest-master/googletest/src/gtest-all.cc;\
	else  \
...
${OBJECTDIR}/AreaMonitor_nomain.o: ${OBJECTDIR}/AreaMonitor.o AreaMonitor.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AreaMonitor_nomain.o AreaMonitor.cpp;\
	else  \
...
${OBJECTDIR}/CO2FSM_nomain.o: ${OBJECTDIR}/CO2FSM.o CO2FSM.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CO2FSM_nomain.o CO2FSM.cpp;\
	else  \
...
${OBJECTDIR}/HumidFSM_nomain.o: ${OBJECTDIR}/HumidFSM.o HumidFSM.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HumidFSM_nomain.o HumidFSM.cpp;\
	else  \
...
${OBJECTDIR}/Humidifier_nomain.o: ${OBJECTDIR}/Humidifier.o Humidifier.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Humidifier_nomain.o Humidifier.cpp;\
	else  \
